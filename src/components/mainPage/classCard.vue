<template>
  <v-hover v-slot="{ hover }">
    ...
    <v-card :elevation="hover ? 8 : 4" height="235px" rounded="lg">
      ...
      <!-- 과목 담당자. 과목 배정 시간 렌더링 -->
      <v-card-text class="text-center" style="height: 50%;">
        <p class="text-h6 font-weight-bold">{{ classData.teacher }} 선생님</p>
